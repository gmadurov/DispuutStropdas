...
path = "/home/gusmadvol/Developer/WebDev/STROPDAS/DispuutStropdas"
if os.getcwd() == path:
...
#### AUTHENTICATION
from API.authentication import CORS_ALLOWED_ORIGINS ,CORS_ALLOW_ALL_ORIGINS , REST_FRAMEWORK , SIMPLE_JWT
